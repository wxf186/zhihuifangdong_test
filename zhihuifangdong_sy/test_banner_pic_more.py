...
class TestActivity:
    ...
    def test_18_banner_pic_more(self):
        """Banner图片"""
        print("\n🎨 测试Banner图片...")
        response = api_request("GET", "/core/app/activity/bannerPicMore")
        print(f"响应: {json.dumps(response, ensure_ascii=False, indent=2)}")
        validate_response(response)
        print("✅ Banner图片获取成功")
        record_result("test_18_banner_pic_more", "/core/app/activity/bannerPicMore", response, "PASSED", group=TEST_GROUP)
