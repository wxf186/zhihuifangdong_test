...
class TestActivity:
    ...
    def test_22_query_version_info(self):
        """版本信息查询"""
        print("\n📱 测试版本信息查询...")
        response = api_request("GET", "/core/app/activity/queryVersionInfo")
        print(f"响应: {json.dumps(response, ensure_ascii=False, indent=2)}")
        validate_response(response)
        print("✅ 版本信息查询完成")
        record_result("test_22_query_version_info", "/core/app/activity/queryVersionInfo", response, "PASSED", group=TEST_GROUP)
