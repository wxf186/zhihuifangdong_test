...
# -*- coding: utf-8 -*-
"""
智慧房东 APP - /core/web/template/choose 接口测试
"""
...
TEST_GROUP = "fy"
class TestApartment:
    """/core/web/template/choose"""

    def test_19_template_choose(self):
        """公寓模版列表"""
        print("\n📋 测试公寓模版列表...")
        response = base_tester.api_request("GET", "/core/web/template/choose")
        ...
        print(f"✅ 公寓模版列表获取成功")
        base_tester.record_result("test_19_template_choose", "/core/web/template/choose", response, "PASSED", group=TEST_GROUP)
...
if __name__ == "__main__":
    ...
    method = getattr(instance, "test_19_template_choose")
    METHOD_RECORDED = False
    try:
        method()
        print("\n✅ " + "test_19_template_choose" + " 执行通过")
