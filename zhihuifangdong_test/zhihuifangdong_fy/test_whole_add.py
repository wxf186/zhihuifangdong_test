    ...
    def test_05_whole_add(self):
        ...
        for attempt in range(max_retries):
            ...
            if response.get("success"):
                house_id = response.get("data")
                print(f"✅ 新增整租房源成功，房源ID: {house_id}")
                base_tester.record_result("test_05_whole_add", "/core/houseAdd/wholeAdd", response, "PASSED", group=TEST_GROUP)
                return
            ...
            # 其他错误直接失败
            base_tester.record_result("test_05_whole_add", "/core/houseAdd/wholeAdd", response, "FAILED", group=TEST_GROUP)
