...
# -*- coding: utf-8 -*-
"""
智慧房东 APP - /core/app/house/getCotenancyHouseIndex 接口测试
"""
...
class TestHouseIndex:
    """/core/app/house/getCotenancyHouseIndex"""

    def test_09_get_cotenancy_house_index(self):
        """合租房详情查询"""
        print("\n📋 测试合租房详情查询...")
        ...
        print(f"✅ 合租房详情查询成功")
        base_tester.record_result("test_09_get_cotenancy_house_index", "/core/app/house/getCotenancyHouseIndex", response, "PASSED", group=TEST_GROUP)
...
if __name__ == "__main__":
    ...
    method = getattr(instance, "test_09_get_cotenancy_house_index")
    METHOD_RECORDED = False
    try:
        method()
        print("\n✅ " + "test_09_get_cotenancy_house_index" + " 执行通过")
