...
# -*- coding: utf-8 -*-
"""
智慧房东 APP - /core/app/house/cityChooseA 接口测试
"""
...
TEST_GROUP = "fy"
class TestDistrict:
    """/core/app/house/cityChooseA"""

    def test_13_city_choose(self):
        """城市列表获取"""
        print("\n📋 测试城市列表获取...")
        ...
        print(f"✅ 城市列表获取成功")
        base_tester.record_result("test_13_city_choose", "/core/app/house/cityChooseA", response, "PASSED", group=TEST_GROUP)
...
if __name__ == "__main__":
    ...
    method = getattr(instance, "test_13_city_choose")
    METHOD_RECORDED = False
    try:
        method()
        print("\n✅ " + "test_13_city_choose" + " 执行通过")
        ...
        print("\n❌ " + "test_13_city_choose" + " 执行失败: " + str(e))
