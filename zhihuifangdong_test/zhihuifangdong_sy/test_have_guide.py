...
class TestUserInfo:
    ...
    def test_06_have_guide(self):
        ...
        print("\n📋 测试新手引导状态...")
        response = base_tester.api_request("GET", "/core/app/user/haveGuide")
        ...
        print("✅ 新手引导状态查询完成")
        base_tester.record_result("test_06_have_guide", "/core/app/user/haveGuide", response, "PASSED", group=TEST_GROUP)
