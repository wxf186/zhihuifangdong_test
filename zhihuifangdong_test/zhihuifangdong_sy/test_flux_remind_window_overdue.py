...
class TestMeter:
    ...
    def test_26_flux_remind_window_overdue(self):
        ...
        _start = time.time()
        time.sleep(0.5)
        response = base_tester.api_request("GET", "/netty/web/meter/fluxRemindWindowOverdue",
        ...
        try:
            ...
            base_tester.record_result("test_26_flux_remind_window_overdue", "/netty/web/meter/fluxRemindWindowOverdue", response, "PASSED", group=TEST_GROUP)
        except AssertionError:
            base_tester.record_result("test_26_flux_remind_window_overdue", "/netty/web/meter/fluxRemindWindowOverdue", response, "FAILED", group=TEST_GROUP)
            raise
        finally:
