...
# -*- coding: utf-8 -*-
"""
智慧房东 APP - /core/app/house/countWaitingReadMessage 接口测试
"""
...
class TestHouse:
    """/core/app/house/countWaitingReadMessage"""

    def test_13_count_waiting_read_message(self):
        """未读消息数"""
        print("\n📬 测试未读消息数...")
        response = base_tester.api_request("GET", "/core/app/house/countWaitingReadMessage")
        ...
        base_tester.record_result("test_13_count_waiting_read_message", "/core/app/house/countWaitingReadMessage", response, "PASSED", group=TEST_GROUP)
...
if __name__ == "__main__":
    ...
    instance = TestHouse()
    method = getattr(instance, "test_13_count_waiting_read_message")
    METHOD_RECORDED = False
    try:
        method()
        print("\n✅ " + "test_13_count_waiting_read_message" + " 执行通过")
        ...
        base_tester.record_result(
            "test_13_count_waiting_read_message",
            api_path_val,
            exc_response if exc_response else {"success": False, "message": str(e)},
            "FAILED"
        , group=TEST_GROUP)
        print("\n❌ " + "test_13_count_waiting_read_message" + " 执行失败: " + str(e))
